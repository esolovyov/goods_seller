...
class WarehousesControllerTest < ActionController::TestCase
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post :create, warehouse: { adress: @warehouse.adress, name: @warehouse.name, region: @warehouse.region, size: @warehouse.size, stock_id: @warehouse.stock_id }
    end
  ...
  test "should update warehouse" do
    patch :update, id: @warehouse, warehouse: { adress: @warehouse.adress, name: @warehouse.name, region: @warehouse.region, size: @warehouse.size, stock_id: @warehouse.stock_id }
    assert_redirected_to warehouse_path(assigns(:warehouse))
  end
