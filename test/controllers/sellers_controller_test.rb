...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { active: @seller.active, address: @seller.address, raiting: @seller.raiting, region: @seller.region, user_id: @seller.user_id }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { active: @seller.active, address: @seller.address, raiting: @seller.raiting, region: @seller.region, user_id: @seller.user_id }
    assert_redirected_to seller_path(assigns(:seller))
  end
